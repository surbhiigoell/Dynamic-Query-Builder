#pragma checksum "D:\QueryBuilder (3)\QueryBuilder\Views\Columns\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2e3f6a829ab77865adf1d72ba09030e0ee36930f"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2e3f6a829ab77865adf1d72ba09030e0ee36930f", @"/Views/Columns/Index.cshtml")]
    public class Views_Columns_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#nullable restore
#line 1 "D:\QueryBuilder (3)\QueryBuilder\Views\Columns\Index.cshtml"
...
<style>
    ...
    .input-box {
        ...
        margin-le");
            WriteLiteral(@"ft: 10px; /* Adjust margin as needed */
    }
...
");
#nullable restore
#line 177 "D:\QueryBuilder (3)\QueryBuilder\Views\Columns\Index.cshtml"
...
#nullable disable
            WriteLiteral("                    <option");
            BeginWriteAttribute("value", " value=", 5214, "", 5226, 1);
#nullable restore
#line 183 "D:\QueryBuilder (3)\QueryBuilder\Views\Columns\Index.cshtml"
WriteAttributeValue("", 5221, item, 5221, 5, false);
...
#nullable disable
            WriteLiteral("</option>\r\n");
#nullable restore
#line 184 "D:\QueryBuilder (3)\QueryBuilder\Views\Columns\Index.cshtml"
                }
            ...
            <div class=""row condition-row"">
                <div class=""col"">
                    <select id=""ColumnDropdown"" class=""form-control column-selector"">
                        <option");
            BeginWriteAttribute("value", " value=\"", 6217, "\"", 6225, 0);
            EndWriteAttribute();
            WriteLiteral(@">Select Condition Column</option>
                ...
                <div class=""col"">
                    <select class=""form-control logical-operator-selector"">
                        ...
                        <");
            WriteLiteral(@"option value=""OR"">OR</option>
                    </select>
                </div>
            </div>
        </div>
...
<script>
    ...
    document.getElementById(""tableSelector"").addEventListener(""change"", function () {
        ...
        applyConditionSubHeading.i");
            WriteLiteral(@"nnerText = ""To select multiple conditions, select column name, the desired arithmatic operator, desired value and logical operator."";
    ...
    document.getElementById(""conditionsContainer"").addEventListener(""change"", function (event) {
        ...
        if (target.classList.contains(""column-selector"")) {
            va");
            WriteLiteral(@"r selectedOption = target.value;
        ...
        if (target.classList.contains(""logical-operator-selector"")) {
            ...
            var currentRow = target.closest("".condition-row"");
            var nextRow ");
            WriteLiteral(@"= currentRow.nextElementSibling;
    ...
    function addNewRowForColumnDropdown(tableName) {
        ...
        <div class=""col"">
            <select id=""ColumnDropdown"" class=""f");
            WriteLiteral(@"orm-control column-selector"">
        ...
        <div class=""col"">
            <select class=""form-control logical-operator-selector"" style=""display: none;"">
                ...
                <option value=""AND"">AND</option>
                <optio");
            WriteLiteral(@"n value=""OR"">OR</option>
            </select>
        </div>`;
    ...
    <div class=""col"">
        <input t");
            WriteLiteral(@"ype=""text"" class=""form-control data-input"" style=""display: none;"" placeholder=""Enter Data"">
    </div>
    <div class=""col"">
        <select class=""form-control logical-operator-selector"" style=""display: none;"">
            <option value=""NONE"">NONE</option>
    ...
    function fetchColumnsForDropdown(tableName) {
     ...
     ");
            WriteLiteral(@"           if (ColumnDropdown.value === ""Select Condition Column"") {
    ...
    document.getElementById(""goButton"").addEventListener(""click"", function () {
        ...
        var conditions = [];
        document.querySelectorAll("".conditio");
            WriteLiteral(@"n-row"").forEach(row => {
        ...
        fetch(`/api/data/${selectedTable}`, {
            ...
            .then(data => {
                if ($.fn.DataTable.isDataTable('#resultTable')) {
                 ");
            WriteLiteral(@"   $('#resultTable').DataTable().destroy();
                }
                ...
                for (var i = 0; i < data.length; i++) {
                    var rowData = data[i];
                    var row = document.createElement(""tr""); // Create a n");
            WriteLiteral(@"ew table row for each row of data
    ...
    var");
            WriteLiteral(@" firstTimeselectConditionOption = document.createElement(""option"");
    ...
    document.getElementById(""saveTemplateButton"").addEventListener(""click"", function () {
        ...
        var requestData = {
            ...
            columns: selectedColumns,
  ");
            WriteLiteral(@"          conditions: conditions
        };
